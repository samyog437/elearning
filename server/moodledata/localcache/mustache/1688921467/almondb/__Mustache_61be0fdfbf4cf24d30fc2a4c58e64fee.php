...
class __Mustache_61be0fdfbf4cf24d30fc2a4c58e64fee extends Mustache_Template
{
...
';
        ...
        $buffer .= $indent . '            </div>
';
        $value = $context->find('courseheaderimg');
        $buffer .= $this->sectionAfc94a9d79f4d2705f19e4fa2e2c5125($context, $indent, $value);
        $buffer .= $indent . '
';
        $value = $context->find('courseheaderimg');
        if (empty($value)) {
...
';
        $buffer .= $indent . '        </div>
';
        if ($partial = $this->mustache->loadPartial('theme_almondb/footer')) {
            $buffer .= $partial->renderInternal($context, $indent . '        ');
        }
        $buffer .= $indent . '    </div>
';
...
';
    ...
    private function sectionAfc94a9d79f4d2705f19e4fa2e2c5125(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        ...
        if (!is_string($value) && is_callable($value)) {
            ...
            <div class="page-header-wrapper has-course-header-image">
                <div class="course-header-bg">
                    <div class="course-header-image" 
                        style="background-image: url(\'{{{courseheaderimg}}}\');">
                    </div>
            ...
            foreach ($values as $value) {
                ...
                $buffer .= $indent . '            <div class="page-header-wrapper has-course-header-image">
';
                $buffer .= $indent . '                <div class="course-header-bg">
';
                $buffer .= $indent . '                    <div class="course-header-image" 
';
                $buffer .= $indent . '                        style="background-image: url(\'';
                $value = $this->resolveValue($context->find('courseheaderimg'), $context);
                $buffer .= ($value === null ? '' : $value);
                $buffer .= '\');">
';
                $buffer .= $indent . '                    </div>
';
                $buffer .= $indent . '                    <div class="course-header-txt">
';
                $buffer .= $indent . '                        ';
                $value = $this->resolveValue($context->findDot('output.full_header'), $context);
                $buffer .= ($value === null ? '' : $value);
