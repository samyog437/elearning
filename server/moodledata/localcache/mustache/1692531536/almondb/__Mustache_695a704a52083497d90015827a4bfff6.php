...
class __Mustache_695a704a52083497d90015827a4bfff6 extends Mustache_Template
{
...
';
        $buffer .= $indent . '    data-toggle="tooltip" data-placement="bottom" 
';
        $buffer .= $indent . '    ';
        $value = $context->find('unauthenticateduser');
        $buffer .= $this->section1e33c8861f4e3ad7849fe6801b15f604($context, $indent, $value);
        $buffer .= '>
';
        $value = $context->find('unauthenticateduser');
        $buffer .= $this->sectionE9637e463d46aeee9a312d6560431210($context, $indent, $value);
        $value = $context->find('unauthenticateduser');
        if (empty($value)) {
...
';
    ...
    private function section9afd7138f3549f97f7a2e431e7b26d6d(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
    
        if (!is_string($value) && is_callable($value)) {
            $source = 'title="{{#str}} loggedinasguest, core {{/str}}"';
            $result = (string) call_user_func($value, $source, $this->lambdaHelper);
            $buffer .= $result;
        } elseif (!empty($value)) {
            $values = $this->isIterable($value) ? $value : array($value);
    ...
    private function section1e33c8861f4e3ad7849fe6801b15f604(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
    
        if (!is_string($value) && is_callable($value)) {
            $source = '{{#guest}}title="{{#str}} loggedinasguest, core {{/str}}"{{/guest}}';
            $result = (string) call_user_func($value, $source, $this->lambdaHelper);
            $buffer .= $result;
        } elseif (!empty($value)) {
            $values = $this->isIterable($value) ? $value : array($value);
            foreach ($values as $value) {
                ...
                $buffer .= $this->section9afd7138f3549f97f7a2e431e7b26d6d($context, $indent, $value);
                $context->pop();
            }
        }
...
';
    ...
    private function sectionE9637e463d46aeee9a312d6560431210(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
